...
**Here, I am testing the folder to see if the test file and test folder are going to show up in the "Shared Files" folder on server when I add files from the client computer. (It was successful)**<br><br><br>
---
